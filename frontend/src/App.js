...
function App() {
  ...
  const columns = [
    { title: "Vision", field: "vis", sorting: false, filtering: false, cellStyle: { background:"#009688" }, headerStyle: { color: "#fff" } },
      ...
      <MaterialTable columns={columns} data={tableData}
        editable={{
          onRowAdd: (newRow) => new Promise((resolve, reject) => {
            ...
            axios.post('http://localhost:5000/criteria1/add', newRow)
          ...
          onRowDelete: (selectedRow) => new Promise((resolve, reject) => {
            ...
            axios.post('http://localhost:5000/criteria1/delete/:', selectedRow.tableData.id)
